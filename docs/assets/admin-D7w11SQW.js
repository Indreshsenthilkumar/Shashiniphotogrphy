import"./style-BqiAwLdI.js";const y="http://127.0.0.1:5001/api",k="https://script.google.com/macros/s/AKfycbxu6hp66vbNm1k6QAoy-or27HxtZ1nC8aD79rdUIaHsyGxXNkU7rSBYHKlS1vAErn8n/exec";window.onerror=function(t){return console.error("[Admin Shield]",t),!0};window.onunhandledrejection=function(t){console.error("[Admin Shield] Rejection",t.reason)};function v(t){return t?t.startsWith("http")||t.startsWith("data:")||t.startsWith("./")||t.startsWith("../")?t:t.startsWith("/")?y+t:y+"/"+t:""}function c(t,e="success"){const o=document.createElement("div");o.style.cssText=`
        position: fixed;
        top: 100px;
        right: 30px;
